...
**Prerequisites:** Make sure you have Java and http://pandoc.org[pandoc] installed on your system.
On Ubuntu/Debian: `sudo apt install pandoc`. On macOS: `brew install pandoc`. On Windows: download from pandoc.org.
